...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(g_Window))
	{
		...
		// HUD MUST BE DRAWN LAST
		glDisable(GL_DEPTH_TEST);
		g_ViewManager->DrawHUDText(10, 720, "W: Move Forward");
		g_ViewManager->DrawHUDText(10, 700, "S: Move Backward");
		g_ViewManager->DrawHUDText(10, 680, "A: Move Left");
		g_ViewManager->DrawHUDText(10, 660, "D: Move Right");
		g_ViewManager->DrawHUDText(10, 640, "Q: Move Up");
		g_ViewManager->DrawHUDText(10, 620, "E: Move Down");
		g_ViewManager->DrawHUDText(10, 600, "Mouse: Look Around");
		g_ViewManager->DrawHUDText(10, 580, "Scroll: Adjust Movement Speed");
		g_ViewManager->DrawHUDText(10, 560, "F: Main Light Toggle (returns to default intensity when back on)");
		g_ViewManager->DrawHUDText(10, 540, "+: Increase Main Light Intensity");
		g_ViewManager->DrawHUDText(10, 520, "-: Decrease Main Light Intensity");
		g_ViewManager->DrawHUDText(10, 500, "C: Cinematic Orbit");
		g_ViewManager->DrawHUDText(10, 480, "P: Perspective View");
		g_ViewManager->DrawHUDText(10, 460, "O: Orthographic View");
		g_ViewManager->DrawHUDText(10, 440, "L: Toggle Logging");
		g_ViewManager->DrawHUDText(10, 420, "ESC: Exit Program");
